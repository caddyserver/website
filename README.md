...
- To display the retro hit counter (just for fun), install the [caddy-hitcounter](https://github.com/mholt/caddy-hitcounter) plugin. Then uncomment the relevant lines in the Caddyfile.
